...
SELECT gender, SUM(purchase_amount) AS "Total revenue genertaed"
FROM customer
GROUP BY gender;
...
SELECT subscription_status, COUNT(customer_id) AS "no_of_customer", ROUND(AVG(purchase_amount),2) AS "average_spend", ROUND(SUM(purchase_amount),2) AS "total_revenue"
FROM customer
